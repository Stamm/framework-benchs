 ...
 * @scope prototype
 */
class VariableFrontend extends VariableFrontend_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Cache\Frontend\VariableFrontend');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Cache\Frontend\VariableFrontend', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Cache_Frontend_VariableFrontend %CLASS%TYPO3_FLOW3_Cache_Frontend_AbstractFrontend4621      