 ...
 * @scope singleton
 */
class FormatResolver extends FormatResolver_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\I18n\FormatResolver', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\I18n\FormatResolver');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\I18n\FormatResolver', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_I18n_FormatResolver4093      