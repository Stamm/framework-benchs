 ...
 */
class FileTypes extends FileTypes_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Utility\FileTypes');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Utility\FileTypes', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Utility_FileTypes3338      