 ...
 */
class PartyRepository extends PartyRepository_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Party\Domain\Repository\PartyRepository');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Party\Domain\Repository\PartyRepository', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Party_Domain_Repository_PartyRepository %CLASS%TYPO3_FLOW3_Persistence_Repository3820      