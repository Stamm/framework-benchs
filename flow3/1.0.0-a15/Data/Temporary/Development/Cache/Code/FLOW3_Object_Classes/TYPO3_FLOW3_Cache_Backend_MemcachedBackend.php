 ...
 * @scope prototype
 */
class MemcachedBackend extends MemcachedBackend_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Cache\Backend\MemcachedBackend');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Cache\Backend\MemcachedBackend', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Cache_Backend_MemcachedBackend %CLASS%TYPO3_FLOW3_Cache_Backend_AbstractBackend4549      