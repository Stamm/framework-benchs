 ...
 */
class DocumentationController extends DocumentationController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Fluid\Controller\DocumentationController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\Controller\DocumentationController', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->docbookGenerator = new \TYPO3\Fluid\Service\DocbookGenerator();
...
#0             %CLASS%TYPO3_Fluid_Controller_DocumentationController %CLASS%TYPO3_FLOW3_MVC_Controller_ActionController %CLASS%TYPO3_FLOW3_MVC_Controller_AbstractController4805      