 ...
 */
class Files extends Files_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Utility\Files');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Utility\Files', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Utility_Files3322      