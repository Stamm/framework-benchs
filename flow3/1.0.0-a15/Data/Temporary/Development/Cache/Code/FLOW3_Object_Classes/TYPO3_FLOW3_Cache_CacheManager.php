 ...
 * @scope singleton
 */
class CacheManager extends CacheManager_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Cache\CacheManager', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Cache\CacheManager');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Cache\CacheManager', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectCacheFactory(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Cache\CacheFactory'));
	}
}
#0             %CLASS%TYPO3_FLOW3_Cache_CacheManager3954      