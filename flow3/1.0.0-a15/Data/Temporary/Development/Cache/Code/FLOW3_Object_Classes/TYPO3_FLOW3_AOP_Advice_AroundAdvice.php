 ...
 * @scope prototype
 */
class AroundAdvice extends AroundAdvice_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\AOP\Advice\AroundAdvice');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\AOP\Advice\AroundAdvice', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_AOP_Advice_AroundAdvice %CLASS%TYPO3_FLOW3_AOP_Advice_AbstractAdvice4701      