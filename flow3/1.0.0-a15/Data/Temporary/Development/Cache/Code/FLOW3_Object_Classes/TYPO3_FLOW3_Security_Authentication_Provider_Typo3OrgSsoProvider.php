 ...
 * @scope prototype
 */
class Typo3OrgSsoProvider extends Typo3OrgSsoProvider_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
		...
		$result = parent::authenticate($authenticationToken);
			...
			try {
				...
				$methodArguments['authenticationToken'] = $authenticationToken;
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Security\Authentication\Provider\Typo3OrgSsoProvider', 'authenticate', $methodArguments, NULL, $result);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Authentication\Provider\Typo3OrgSsoProvider');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Authentication\Provider\Typo3OrgSsoProvider', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->rsaWalletService = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Security\Cryptography\RsaWalletServiceInterface');
	}
}
#0             %CLASS%TYPO3_FLOW3_Security_Authentication_Provider_Typo3OrgSsoProvider8775      