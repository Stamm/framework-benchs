 ...
 * @scope singleton
 */
class PolicyService extends PolicyService_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Policy\PolicyService', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Policy\PolicyService');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Policy\PolicyService', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->injectPolicyExpressionParser(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Security\Policy\PolicyExpressionParser'));
		$this->injectObjectManager(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Object\ObjectManagerInterface'));
	}
}
#0             %CLASS%TYPO3_FLOW3_Security_Policy_PolicyService4773      