 ...
 * @scope singleton
 */
class AfterInvocationProcessorManager extends AfterInvocationProcessorManager_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\AfterInvocationProcessorManager', $this);
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\AfterInvocationManagerInterface', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Authorization\AfterInvocationProcessorManager');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Authorization\AfterInvocationProcessorManager', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Authorization_AfterInvocationProcessorManager4141      