 ...
 * @scope singleton
 */
class WidgetRequestBuilder extends WidgetRequestBuilder_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\Fluid\Core\Widget\WidgetRequestBuilder', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Fluid\Core\Widget\WidgetRequestBuilder');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\Core\Widget\WidgetRequestBuilder', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectAjaxWidgetContextHolder(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\Fluid\Core\Widget\AjaxWidgetContextHolder'));
		...
		$this->injectConfigurationManager(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Configuration\ConfigurationManager'));
		$this->injectRouter(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\MVC\Web\Routing\RouterInterface'));
	}
}
#0             %CLASS%TYPO3_Fluid_Core_Widget_WidgetRequestBuilder %CLASS%TYPO3_FLOW3_MVC_Web_RequestBuilder4579      