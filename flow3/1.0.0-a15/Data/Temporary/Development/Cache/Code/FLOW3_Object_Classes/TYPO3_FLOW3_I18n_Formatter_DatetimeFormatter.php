 ...
 * @scope singleton
 */
class DatetimeFormatter extends DatetimeFormatter_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\I18n\Formatter\DatetimeFormatter', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\I18n\Formatter\DatetimeFormatter');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\I18n\Formatter\DatetimeFormatter', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectDatesReader(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\Cldr\Reader\DatesReader'));
	}
}
#0             %CLASS%TYPO3_FLOW3_I18n_Formatter_DatetimeFormatter4038      