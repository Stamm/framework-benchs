 ...
 * @scope prototype
 */
class PhpFrontend extends PhpFrontend_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (!isset($arguments[1])) throw new \TYPO3\FLOW3\Object\Exception\UnresolvedDependenciesException('Missing required constructor argument $backend in class ' . __CLASS__ . '. Note that constructor injection is only support for objects of scope singleton (and this is not a singleton) – for other scopes you must pass each required argument to the constructor yourself.', 1296143788);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Cache\Frontend\PhpFrontend');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Cache\Frontend\PhpFrontend', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Cache_Frontend_PhpFrontend %CLASS%TYPO3_FLOW3_Cache_Frontend_StringFrontend %CLASS%TYPO3_FLOW3_Cache_Frontend_AbstractFrontend4513      