 ...
 * @scope singleton
 */
class XliffParser extends XliffParser_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\I18n\Xliff\XliffParser', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\I18n\Xliff\XliffParser');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\I18n\Xliff\XliffParser', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_I18n_Xliff_XliffParser %CLASS%TYPO3_FLOW3_I18n_Xml_AbstractXmlParser3675      