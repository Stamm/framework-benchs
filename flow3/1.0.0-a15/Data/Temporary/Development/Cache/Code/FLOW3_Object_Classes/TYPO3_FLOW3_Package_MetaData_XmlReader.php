 ...
 * @scope singleton
 */
class XmlReader extends XmlReader_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Package\MetaData\XmlReader', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Package\MetaData\XmlReader');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Package\MetaData\XmlReader', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Package_MetaData_XmlReader3693      