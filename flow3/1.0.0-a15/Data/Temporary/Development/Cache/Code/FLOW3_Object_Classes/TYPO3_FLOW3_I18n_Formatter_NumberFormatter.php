 ...
 * @scope singleton
 */
class NumberFormatter extends NumberFormatter_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\I18n\Formatter\NumberFormatter', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\I18n\Formatter\NumberFormatter');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\I18n\Formatter\NumberFormatter', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectNumbersReader(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\Cldr\Reader\NumbersReader'));
	}
}
#0             %CLASS%TYPO3_FLOW3_I18n_Formatter_NumberFormatter4030      