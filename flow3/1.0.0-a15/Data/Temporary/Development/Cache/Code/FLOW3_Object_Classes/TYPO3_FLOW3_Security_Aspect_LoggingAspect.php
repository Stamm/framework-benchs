 ...
 * @aspect 
 */
class LoggingAspect extends LoggingAspect_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Aspect\LoggingAspect', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Aspect\LoggingAspect');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Aspect\LoggingAspect', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Aspect_LoggingAspect4028      