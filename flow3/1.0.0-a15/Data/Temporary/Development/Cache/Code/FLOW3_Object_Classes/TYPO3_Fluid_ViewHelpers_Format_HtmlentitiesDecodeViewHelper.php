 ...
 */
class HtmlentitiesDecodeViewHelper extends HtmlentitiesDecodeViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Fluid\ViewHelpers\Format\HtmlentitiesDecodeViewHelper');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\ViewHelpers\Format\HtmlentitiesDecodeViewHelper', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Fluid_ViewHelpers_Format_HtmlentitiesDecodeViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper3838      