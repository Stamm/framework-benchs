 ...
 * @scope singleton
 */
class AccountFactory extends AccountFactory_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\AccountFactory', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\AccountFactory');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\AccountFactory', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_AccountFactory3990      