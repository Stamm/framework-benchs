 ...
 * @scope prototype
 */
class NumberValidator extends NumberValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\NumberValidator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\NumberValidator', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->injectNumberParser(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\Parser\NumberParser'));
	}
}
#0             %CLASS%TYPO3_FLOW3_Validation_Validator_NumberValidator %CLASS%TYPO3_FLOW3_Validation_Validator_AbstractValidator4150      