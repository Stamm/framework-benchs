 ...
 * @scope prototype
 */
class PersonNameValidator extends PersonNameValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Party\Domain\Validator\PersonNameValidator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Party\Domain\Validator\PersonNameValidator', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Party_Domain_Validator_PersonNameValidator %CLASS%TYPO3_FLOW3_Validation_Validator_AbstractValidator3730      