 ...
 * @scope prototype
 */
abstract class AbstractSqlBackend extends AbstractSqlBackend_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
		...
		$result = parent::emitRemovedObject($object);
			...
			try {
				...
				$methodArguments['object'] = $object;
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Generic\Backend\AbstractSqlBackend', 'emitRemovedObject', $methodArguments);
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Generic\Backend\AbstractSqlBackend', 'emitRemovedObject', $methodArguments, NULL, $result);
		...
		$result = parent::emitPersistedObject($object, $objectState);
			...
			try {
				...
				$methodArguments['objectState'] = $objectState;
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Generic\Backend\AbstractSqlBackend', 'emitPersistedObject', $methodArguments);
					$result = $this->FLOW3_AOP_Proxy_invokeJoinPoint($joinPoint);
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Generic\Backend\AbstractSqlBackend', 'emitPersistedObject', $methodArguments, NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
...
#0             %CLASS%TYPO3_FLOW3_Persistence_Generic_Backend_AbstractSqlBackend %CLASS%TYPO3_FLOW3_Persistence_Generic_Backend_AbstractBackend5805      