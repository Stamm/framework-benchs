 ...
 * @scope prototype
 */
class ResourceStreamWrapper extends ResourceStreamWrapper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Resource\Streams\ResourceStreamWrapper');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Resource\Streams\ResourceStreamWrapper', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->resourceManager = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Resource\ResourceManager');
	}
}
#0             %CLASS%TYPO3_FLOW3_Resource_Streams_ResourceStreamWrapper3942      