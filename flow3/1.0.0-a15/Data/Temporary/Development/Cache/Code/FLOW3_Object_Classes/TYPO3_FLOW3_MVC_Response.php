...
class Response extends Response_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\Response');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\Response', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_MVC_Response3342      