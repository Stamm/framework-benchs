 ...
 * @scope singleton
 */
class AdvicedMethodInterceptorBuilder extends AdvicedMethodInterceptorBuilder_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\AOP\Builder\AdvicedMethodInterceptorBuilder', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\AOP\Builder\AdvicedMethodInterceptorBuilder');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\AOP\Builder\AdvicedMethodInterceptorBuilder', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->injectCompiler(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Object\Proxy\Compiler'));
	}
}
#0             %CLASS%TYPO3_FLOW3_AOP_Builder_AdvicedMethodInterceptorBuilder %CLASS%TYPO3_FLOW3_AOP_Builder_AbstractMethodInterceptorBuilder4231      