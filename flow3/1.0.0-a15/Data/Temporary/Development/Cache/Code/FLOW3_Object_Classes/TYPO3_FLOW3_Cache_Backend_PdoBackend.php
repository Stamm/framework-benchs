 ...
 * @scope prototype
 */
class PdoBackend extends PdoBackend_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Cache\Backend\PdoBackend');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Cache\Backend\PdoBackend', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Cache_Backend_PdoBackend %CLASS%TYPO3_FLOW3_Cache_Backend_AbstractBackend4525      