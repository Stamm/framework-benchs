 ...
 * @scope singleton
 */
class PluralsReader extends PluralsReader_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\I18n\Cldr\Reader\PluralsReader', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\I18n\Cldr\Reader\PluralsReader');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\I18n\Cldr\Reader\PluralsReader', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectCache(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Cache\CacheManager')->getCache('FLOW3_I18n_Cldr_Reader_PluralsReaderCache'));
		$this->injectCldrRepository(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\Cldr\CldrRepository'));
	}
}
#0             %CLASS%TYPO3_FLOW3_I18n_Cldr_Reader_PluralsReader4288      