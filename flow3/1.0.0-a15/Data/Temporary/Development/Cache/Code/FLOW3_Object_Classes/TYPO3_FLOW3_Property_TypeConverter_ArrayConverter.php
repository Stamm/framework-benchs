 ...
 * @scope singleton
 */
class ArrayConverter extends ArrayConverter_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Property\TypeConverter\ArrayConverter', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Property\TypeConverter\ArrayConverter');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Property\TypeConverter\ArrayConverter', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Property_TypeConverter_ArrayConverter %CLASS%TYPO3_FLOW3_Property_TypeConverter_AbstractTypeConverter3753      