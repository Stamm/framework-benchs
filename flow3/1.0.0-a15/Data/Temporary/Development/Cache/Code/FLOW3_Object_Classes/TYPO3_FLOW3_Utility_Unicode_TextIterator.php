 ...
 * @scope singleton
 */
class TextIterator extends TextIterator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Utility\Unicode\TextIterator', $this);

		if (!isset($arguments[1])) $arguments[1] = 3;
		if (!isset($arguments[0])) throw new \TYPO3\FLOW3\Object\Exception\UnresolvedDependenciesException('Missing required constructor argument $subject in class ' . __CLASS__ . '. Please check your calling code and Dependency Injection configuration.', 1296143787);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Utility\Unicode\TextIterator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Utility\Unicode\TextIterator', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Utility_Unicode_TextIterator4190      