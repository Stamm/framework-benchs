 ...
 * @scope singleton
 */
class Utility extends Utility_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\I18n\Utility', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\I18n\Utility');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\I18n\Utility', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_I18n_Utility3621      