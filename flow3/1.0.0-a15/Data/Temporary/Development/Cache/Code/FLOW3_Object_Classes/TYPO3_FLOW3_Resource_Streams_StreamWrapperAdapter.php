 ...
 * @scope prototype
 */
class StreamWrapperAdapter extends StreamWrapperAdapter_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Resource\Streams\StreamWrapperAdapter');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Resource\Streams\StreamWrapperAdapter', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Resource_Streams_StreamWrapperAdapter3817      