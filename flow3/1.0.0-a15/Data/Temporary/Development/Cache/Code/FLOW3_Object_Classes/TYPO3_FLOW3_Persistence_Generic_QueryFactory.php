 ...
 */
class QueryFactory extends QueryFactory_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Persistence\Generic\QueryFactory');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Persistence\Generic\QueryFactory', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Persistence_Generic_QueryFactory3386      