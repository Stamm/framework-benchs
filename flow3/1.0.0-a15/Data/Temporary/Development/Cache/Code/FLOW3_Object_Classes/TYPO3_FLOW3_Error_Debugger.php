 ...
 */
class Debugger extends Debugger_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Error\Debugger');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Error\Debugger', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Error_Debugger3716      