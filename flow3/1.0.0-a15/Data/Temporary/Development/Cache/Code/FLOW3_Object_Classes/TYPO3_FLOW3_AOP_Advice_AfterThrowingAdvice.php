 ...
 * @scope prototype
 */
class AfterThrowingAdvice extends AfterThrowingAdvice_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\AOP\Advice\AfterThrowingAdvice');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\AOP\Advice\AfterThrowingAdvice', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_AOP_Advice_AfterThrowingAdvice %CLASS%TYPO3_FLOW3_AOP_Advice_AbstractAdvice4729      