 ...
 * @scope singleton
 */
class DatesReader extends DatesReader_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\I18n\Cldr\Reader\DatesReader', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\I18n\Cldr\Reader\DatesReader');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\I18n\Cldr\Reader\DatesReader', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectCache(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Cache\CacheManager')->getCache('FLOW3_I18n_Cldr_Reader_DatesReaderCache'));
		$this->injectCldrRepository(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\Cldr\CldrRepository'));
	}
}
#0             %CLASS%TYPO3_FLOW3_I18n_Cldr_Reader_DatesReader4480      