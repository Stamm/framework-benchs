 ...
 * @scope prototype
 */
class DynamicRoutePart extends DynamicRoutePart_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\Web\Routing\DynamicRoutePart');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\Web\Routing\DynamicRoutePart', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_MVC_Web_Routing_DynamicRoutePart %CLASS%TYPO3_FLOW3_MVC_Web_Routing_AbstractRoutePart3410      