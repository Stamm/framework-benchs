 ...
 * @aspect 
 */
class CsrfProtectionAspect extends CsrfProtectionAspect_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Aspect\CsrfProtectionAspect');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Aspect\CsrfProtectionAspect', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Aspect_CsrfProtectionAspect4285      