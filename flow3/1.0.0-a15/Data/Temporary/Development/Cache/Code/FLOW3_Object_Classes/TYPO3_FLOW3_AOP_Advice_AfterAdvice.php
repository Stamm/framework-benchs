 ...
 * @scope prototype
 */
class AfterAdvice extends AfterAdvice_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\AOP\Advice\AfterAdvice');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\AOP\Advice\AfterAdvice', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_AOP_Advice_AfterAdvice %CLASS%TYPO3_FLOW3_AOP_Advice_AbstractAdvice4697      