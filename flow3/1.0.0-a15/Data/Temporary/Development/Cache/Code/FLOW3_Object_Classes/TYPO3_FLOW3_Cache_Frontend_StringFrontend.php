 ...
 * @scope prototype
 */
class StringFrontend extends StringFrontend_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Cache\Frontend\StringFrontend');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Cache\Frontend\StringFrontend', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Cache_Frontend_StringFrontend %CLASS%TYPO3_FLOW3_Cache_Frontend_AbstractFrontend4515      