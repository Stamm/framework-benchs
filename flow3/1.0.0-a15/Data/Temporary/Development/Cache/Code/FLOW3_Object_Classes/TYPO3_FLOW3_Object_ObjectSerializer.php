 ...
 * @scope singleton
 */
class ObjectSerializer extends ObjectSerializer_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Object\ObjectSerializer', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Object\ObjectSerializer');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Object\ObjectSerializer', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Object_ObjectSerializer4275      