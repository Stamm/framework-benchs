 ...
 * @scope singleton
 */
class ResourcePublisher extends ResourcePublisher_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Resource\Publishing\ResourcePublisher', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Resource\Publishing\ResourcePublisher');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Resource\Publishing\ResourcePublisher', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectResourcePublishingTarget(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Resource\Publishing\ResourcePublishingTargetInterface'));
	}
}
#0             %CLASS%TYPO3_FLOW3_Resource_Publishing_ResourcePublisher4101      