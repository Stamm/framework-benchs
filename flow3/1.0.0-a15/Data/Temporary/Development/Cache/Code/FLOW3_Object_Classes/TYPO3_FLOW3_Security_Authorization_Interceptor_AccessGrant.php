 ...
 * @scope singleton
 */
class AccessGrant extends AccessGrant_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\Interceptor\AccessGrant', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Authorization\Interceptor\AccessGrant');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Authorization\Interceptor\AccessGrant', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Authorization_Interceptor_AccessGrant3795      