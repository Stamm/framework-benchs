 ...
 * @scope prototype
 */
class SystemConstraint extends SystemConstraint_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Package\MetaData\SystemConstraint');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Package\MetaData\SystemConstraint', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Package_MetaData_SystemConstraint %CLASS%TYPO3_FLOW3_Package_MetaData_AbstractConstraint4505      