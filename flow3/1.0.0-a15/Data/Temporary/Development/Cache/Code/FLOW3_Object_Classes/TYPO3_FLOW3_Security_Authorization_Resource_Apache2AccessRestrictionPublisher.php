 ...
 * @scope singleton
 */
class Apache2AccessRestrictionPublisher extends Apache2AccessRestrictionPublisher_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\Resource\Apache2AccessRestrictionPublisher', $this);
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\Resource\AccessRestrictionPublisherInterface', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Authorization\Resource\Apache2AccessRestrictionPublisher');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Authorization\Resource\Apache2AccessRestrictionPublisher', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Authorization_Resource_Apache2AccessRestrictionPublisher4517      