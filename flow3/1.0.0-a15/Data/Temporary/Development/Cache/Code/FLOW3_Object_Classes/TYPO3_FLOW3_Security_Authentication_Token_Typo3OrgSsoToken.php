 ...
 * @scope prototype
 */
class Typo3OrgSsoToken extends Typo3OrgSsoToken_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Authentication\Token\Typo3OrgSsoToken');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Authentication\Token\Typo3OrgSsoToken', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->injectAccountRepository(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Security\AccountRepository'));
	}
}
#0             %CLASS%TYPO3_FLOW3_Security_Authentication_Token_Typo3OrgSsoToken3960      