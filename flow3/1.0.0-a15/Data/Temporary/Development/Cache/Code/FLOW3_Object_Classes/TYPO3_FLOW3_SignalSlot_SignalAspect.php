 ...
 * @aspect 
 */
class SignalAspect extends SignalAspect_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\SignalSlot\SignalAspect', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\SignalSlot\SignalAspect');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\SignalSlot\SignalAspect', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->dispatcher = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\SignalSlot\Dispatcher');
	}
}
#0             %CLASS%TYPO3_FLOW3_SignalSlot_SignalAspect3987      