 ...
 * @scope prototype
 */
class RootNode extends RootNode_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Fluid\Core\Parser\SyntaxTree\RootNode');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\Core\Parser\SyntaxTree\RootNode', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Fluid_Core_Parser_SyntaxTree_RootNode %CLASS%TYPO3_Fluid_Core_Parser_SyntaxTree_AbstractNode3399      