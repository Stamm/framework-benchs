 ...
 * @scope singleton
 */
class Arrays extends Arrays_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Utility\Arrays', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Utility\Arrays');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Utility\Arrays', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Utility_Arrays3630      