 ...
 * @scope singleton
 */
class DoctrineCommandController extends DoctrineCommandController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Command\DoctrineCommandController', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Command\DoctrineCommandController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Command\DoctrineCommandController', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->doctrineService = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Persistence\Doctrine\Service');
	}
}
#0             %CLASS%TYPO3_FLOW3_Command_DoctrineCommandController %CLASS%TYPO3_FLOW3_MVC_Controller_CommandController4451      