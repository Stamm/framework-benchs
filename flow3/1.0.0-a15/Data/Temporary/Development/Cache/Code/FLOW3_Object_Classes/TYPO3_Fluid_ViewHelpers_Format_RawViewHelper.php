 ...
 */
class RawViewHelper extends RawViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Fluid\ViewHelpers\Format\RawViewHelper');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\ViewHelpers\Format\RawViewHelper', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Fluid_ViewHelpers_Format_RawViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper3778      