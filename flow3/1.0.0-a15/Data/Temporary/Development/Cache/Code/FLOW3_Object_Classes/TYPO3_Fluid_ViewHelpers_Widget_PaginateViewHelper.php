 ...
 * @scope prototype
 */
class PaginateViewHelper extends PaginateViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Fluid\ViewHelpers\Widget\PaginateViewHelper');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\ViewHelpers\Widget\PaginateViewHelper', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->controller = new \TYPO3\Fluid\ViewHelpers\Widget\Controller\PaginateController();
	}
}
#0             %CLASS%TYPO3_Fluid_ViewHelpers_Widget_PaginateViewHelper %CLASS%TYPO3_Fluid_Core_Widget_AbstractWidgetViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper4263      