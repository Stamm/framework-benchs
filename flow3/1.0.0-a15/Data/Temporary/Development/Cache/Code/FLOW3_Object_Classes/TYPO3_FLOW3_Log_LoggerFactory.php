 ...
 * @scope singleton
 */
class LoggerFactory extends LoggerFactory_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Log\LoggerFactory', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Log\LoggerFactory');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Log\LoggerFactory', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Log_LoggerFactory3652      