 ...
 * @scope singleton
 */
class InterceptorResolver extends InterceptorResolver_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\InterceptorResolver', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Authorization\InterceptorResolver');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Authorization\InterceptorResolver', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Authorization_InterceptorResolver4395      