 ...
 * @aspect 
 */
class PrivateResourcesPublishingAspect extends PrivateResourcesPublishingAspect_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Aspect\PrivateResourcesPublishingAspect', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Aspect\PrivateResourcesPublishingAspect');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Aspect\PrivateResourcesPublishingAspect', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->accessRestrictionPublisher = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Security\Authorization\Resource\AccessRestrictionPublisherInterface');
	}
}
#0             %CLASS%TYPO3_FLOW3_Security_Aspect_PrivateResourcesPublishingAspect4780      