 ...
 * @scope singleton
 */
class PackageCommandController extends PackageCommandController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Command\PackageCommandController', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Command\PackageCommandController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Command\PackageCommandController', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->packageManager = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Package\PackageManagerInterface');
		$this->bootstrap = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Core\Bootstrap');
	}
}
#0             %CLASS%TYPO3_FLOW3_Command_PackageCommandController %CLASS%TYPO3_FLOW3_MVC_Controller_CommandController4312      