 ...
 * @scope prototype
 */
class Warning extends Warning_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Error\Warning');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Error\Warning', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Error_Warning %CLASS%TYPO3_FLOW3_Error_Message4439      