...
class RequestBuilder extends RequestBuilder_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\MVC\CLI\RequestBuilder', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\CLI\RequestBuilder');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\CLI\RequestBuilder', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_MVC_CLI_RequestBuilder4500      