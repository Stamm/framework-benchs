...
class Algorithms extends Algorithms_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Cryptography\Algorithms');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Cryptography\Algorithms', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Cryptography_Algorithms3384      