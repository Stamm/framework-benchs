 ...
 */
class SaltedMd5HashingStrategy extends SaltedMd5HashingStrategy_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Cryptography\SaltedMd5HashingStrategy');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Cryptography\SaltedMd5HashingStrategy', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Cryptography_SaltedMd5HashingStrategy3440      