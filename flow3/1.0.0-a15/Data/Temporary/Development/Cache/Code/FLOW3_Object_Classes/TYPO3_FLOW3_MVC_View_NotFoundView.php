 ...
 * @scope prototype
 */
class NotFoundView extends NotFoundView_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\View\NotFoundView');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\View\NotFoundView', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_MVC_View_NotFoundView %CLASS%TYPO3_FLOW3_MVC_View_AbstractView3373      