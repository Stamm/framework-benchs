...
class PersistenceManager extends PersistenceManager_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Persistence\Doctrine\PersistenceManager', $this);
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Persistence\PersistenceManagerInterface', $this);
		...
		$result = parent::getObjectByIdentifier($identifier, $objectType);
			...
			try {
				...
				$methodArguments['objectType'] = $objectType;
					...
					$adviceChain->rewind();
					$result = $adviceChain->proceed(new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Doctrine\PersistenceManager', 'getObjectByIdentifier', $methodArguments, $adviceChain));
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Persistence\Doctrine\PersistenceManager');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Persistence\Doctrine\PersistenceManager', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Persistence_Doctrine_PersistenceManager %CLASS%TYPO3_FLOW3_Persistence_AbstractPersistenceManager8422      