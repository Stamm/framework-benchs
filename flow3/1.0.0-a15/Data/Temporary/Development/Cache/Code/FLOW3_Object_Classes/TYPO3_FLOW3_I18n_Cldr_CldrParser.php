 ...
 * @scope singleton
 */
class CldrParser extends CldrParser_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\I18n\Cldr\CldrParser', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\I18n\Cldr\CldrParser');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\I18n\Cldr\CldrParser', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_I18n_Cldr_CldrParser %CLASS%TYPO3_FLOW3_I18n_Xml_AbstractXmlParser3664      