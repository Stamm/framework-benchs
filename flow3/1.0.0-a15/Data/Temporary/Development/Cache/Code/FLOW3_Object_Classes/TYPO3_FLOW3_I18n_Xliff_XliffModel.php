 ...
 * @scope prototype
 */
class XliffModel extends XliffModel_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (!isset($arguments[0])) throw new \TYPO3\FLOW3\Object\Exception\UnresolvedDependenciesException('Missing required constructor argument $sourcePath in class ' . __CLASS__ . '. Note that constructor injection is only support for objects of scope singleton (and this is not a singleton) – for other scopes you must pass each required argument to the constructor yourself.', 1296143788);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\I18n\Xliff\XliffModel');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\I18n\Xliff\XliffModel', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectCache(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Cache\CacheManager')->getCache('FLOW3_I18n_XmlModelCache'));
		$this->injectParser(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\Xliff\XliffParser'));
	}
}
#0             %CLASS%TYPO3_FLOW3_I18n_Xliff_XliffModel %CLASS%TYPO3_FLOW3_I18n_Xml_AbstractXmlModel4711      