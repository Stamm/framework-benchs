 ...
 * @scope singleton
 */
class DocCommentParser extends DocCommentParser_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Reflection\DocCommentParser', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Reflection\DocCommentParser');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Reflection\DocCommentParser', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Reflection_DocCommentParser3705      