 ...
 * @scope prototype
 */
class DynamicOperand extends DynamicOperand_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Persistence\Generic\Qom\DynamicOperand');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Persistence\Generic\Qom\DynamicOperand', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Persistence_Generic_Qom_DynamicOperand %CLASS%TYPO3_FLOW3_Persistence_Generic_Qom_Operand3426      