 ...
 * @scope prototype
 */
class Result extends Result_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Error\Result');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Error\Result', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Error_Result3340      