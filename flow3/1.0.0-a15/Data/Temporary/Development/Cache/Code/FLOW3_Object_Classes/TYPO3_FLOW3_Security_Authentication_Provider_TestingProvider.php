 ...
 * @scope singleton
 */
class TestingProvider extends TestingProvider_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authentication\Provider\TestingProvider', $this);

		if (!isset($arguments[1])) $arguments[1] = array (
);
		if (!isset($arguments[0])) throw new \TYPO3\FLOW3\Object\Exception\UnresolvedDependenciesException('Missing required constructor argument $name in class ' . __CLASS__ . '. Please check your calling code and Dependency Injection configuration.', 1296143787);
		...
		$result = parent::authenticate($authenticationToken);
			...
			try {
				...
				$methodArguments['authenticationToken'] = $authenticationToken;
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Security\Authentication\Provider\TestingProvider', 'authenticate', $methodArguments);
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Security\Authentication\Provider\TestingProvider', 'authenticate', $methodArguments, NULL, $result);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Authentication\Provider\TestingProvider');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Authentication\Provider\TestingProvider', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Authentication_Provider_TestingProvider8116      