 ...
 * @scope prototype
 */
class UploadViewHelper extends UploadViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->propertyMapper = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Property\PropertyMapper');
	}
}
#0             %CLASS%TYPO3_Fluid_ViewHelpers_Form_UploadViewHelper %CLASS%TYPO3_Fluid_ViewHelpers_Form_AbstractFormFieldViewHelper %CLASS%TYPO3_Fluid_ViewHelpers_Form_AbstractFormViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper4176      