 ...
 * @scope singleton
 */
class PropertyMappingConfigurationBuilder extends PropertyMappingConfigurationBuilder_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Property\PropertyMappingConfigurationBuilder', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Property\PropertyMappingConfigurationBuilder');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Property\PropertyMappingConfigurationBuilder', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Property_PropertyMappingConfigurationBuilder3809      