 ...
 * @scope singleton
 */
class FloatValidator extends FloatValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Validation\Validator\FloatValidator', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\FloatValidator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\FloatValidator', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Validation_Validator_FloatValidator %CLASS%TYPO3_FLOW3_Validation_Validator_AbstractValidator3970      