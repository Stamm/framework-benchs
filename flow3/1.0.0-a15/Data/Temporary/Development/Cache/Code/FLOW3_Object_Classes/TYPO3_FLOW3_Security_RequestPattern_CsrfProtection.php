 ...
 * @scope prototype
 */
class CsrfProtection extends CsrfProtection_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\RequestPattern\CsrfProtection');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\RequestPattern\CsrfProtection', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_RequestPattern_CsrfProtection4179      