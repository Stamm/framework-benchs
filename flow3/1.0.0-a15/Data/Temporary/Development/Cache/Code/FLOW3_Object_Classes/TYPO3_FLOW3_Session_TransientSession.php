 ...
 * @scope singleton
 */
class TransientSession extends TransientSession_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Session\TransientSession', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Session\TransientSession');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Session\TransientSession', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Session_TransientSession3690      