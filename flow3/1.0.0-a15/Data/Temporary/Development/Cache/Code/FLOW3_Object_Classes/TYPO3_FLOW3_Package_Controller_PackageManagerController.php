 ...
 * @scope singleton
 */
class PackageManagerController extends PackageManagerController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Package\Controller\PackageManagerController', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Package\Controller\PackageManagerController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Package\Controller\PackageManagerController', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Package_Controller_PackageManagerController %CLASS%TYPO3_FLOW3_MVC_Controller_ActionController %CLASS%TYPO3_FLOW3_MVC_Controller_AbstractController5178      