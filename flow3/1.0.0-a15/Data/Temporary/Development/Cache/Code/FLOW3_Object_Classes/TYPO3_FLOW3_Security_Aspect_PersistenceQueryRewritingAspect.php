 ...
 * @aspect 
 */
class PersistenceQueryRewritingAspect extends PersistenceQueryRewritingAspect_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Aspect\PersistenceQueryRewritingAspect', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Aspect\PersistenceQueryRewritingAspect');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Aspect\PersistenceQueryRewritingAspect', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->injectPolicyService(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Security\Policy\PolicyService'));
...
#0             %CLASS%TYPO3_FLOW3_Security_Aspect_PersistenceQueryRewritingAspect4795      