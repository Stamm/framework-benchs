 ...
 * @scope prototype
 */
class JsonView extends JsonView_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\View\JsonView');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\View\JsonView', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_MVC_View_JsonView %CLASS%TYPO3_FLOW3_MVC_View_AbstractView3755      