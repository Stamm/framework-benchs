 ...
 * @scope singleton
 */
class AccountRepository extends AccountRepository_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\AccountRepository', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\AccountRepository');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\AccountRepository', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_AccountRepository %CLASS%TYPO3_FLOW3_Persistence_Repository4051      