 ...
 * @scope prototype
 */
class TemplateView extends TemplateView_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\View\TemplateView', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->injectTemplateCompiler(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\Fluid\Core\Compiler\TemplateCompiler'));
	}
}
#0             %CLASS%TYPO3_Fluid_View_TemplateView %CLASS%TYPO3_Fluid_View_AbstractTemplateView4044      