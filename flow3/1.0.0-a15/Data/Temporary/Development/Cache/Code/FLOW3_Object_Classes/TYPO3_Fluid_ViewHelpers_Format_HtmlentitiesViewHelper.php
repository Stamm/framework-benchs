 ...
 * @scope singleton
 */
class HtmlentitiesViewHelper extends HtmlentitiesViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\Fluid\ViewHelpers\Format\HtmlentitiesViewHelper', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Fluid\ViewHelpers\Format\HtmlentitiesViewHelper');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\ViewHelpers\Format\HtmlentitiesViewHelper', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Fluid_ViewHelpers_Format_HtmlentitiesViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper4094      