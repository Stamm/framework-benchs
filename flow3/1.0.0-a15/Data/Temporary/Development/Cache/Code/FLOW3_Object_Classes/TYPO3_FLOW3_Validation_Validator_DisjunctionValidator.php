 ...
 * @scope prototype
 */
class DisjunctionValidator extends DisjunctionValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\DisjunctionValidator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\DisjunctionValidator', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Validation_Validator_DisjunctionValidator %CLASS%TYPO3_FLOW3_Validation_Validator_AbstractCompositeValidator3726      