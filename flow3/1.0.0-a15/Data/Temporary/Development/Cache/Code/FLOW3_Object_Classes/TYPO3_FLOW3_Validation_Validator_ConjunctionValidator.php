 ...
 * @scope prototype
 */
class ConjunctionValidator extends ConjunctionValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\ConjunctionValidator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\ConjunctionValidator', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Validation_Validator_ConjunctionValidator %CLASS%TYPO3_FLOW3_Validation_Validator_AbstractCompositeValidator3726      