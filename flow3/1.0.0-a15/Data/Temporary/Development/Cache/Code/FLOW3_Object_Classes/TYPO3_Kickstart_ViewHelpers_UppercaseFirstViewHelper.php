 ...
 * @scope prototype
 */
class UppercaseFirstViewHelper extends UppercaseFirstViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Kickstart\ViewHelpers\UppercaseFirstViewHelper');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Kickstart\ViewHelpers\UppercaseFirstViewHelper', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Kickstart_ViewHelpers_UppercaseFirstViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper3833      