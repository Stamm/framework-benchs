 ...
 * @scope singleton
 */
class RequestPatternResolver extends RequestPatternResolver_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\RequestPatternResolver', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\RequestPatternResolver');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\RequestPatternResolver', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_RequestPatternResolver4343      