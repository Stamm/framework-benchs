 ...
 * @scope singleton
 */
class StringValidator extends StringValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Validation\Validator\StringValidator', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\StringValidator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\StringValidator', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Validation_Validator_StringValidator %CLASS%TYPO3_FLOW3_Validation_Validator_AbstractValidator3976      