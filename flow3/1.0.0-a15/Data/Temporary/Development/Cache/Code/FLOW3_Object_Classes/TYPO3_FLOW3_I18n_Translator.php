 ...
 * @scope singleton
 */
class Translator extends Translator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\I18n\Translator', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\I18n\Translator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\I18n\Translator', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->injectTranslationProvider(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\TranslationProvider\TranslationProviderInterface'));
		$this->injectFormatResolver(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\FormatResolver'));
		$this->injectPluralsReader(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\Cldr\Reader\PluralsReader'));
	}
}
#0             %CLASS%TYPO3_FLOW3_I18n_Translator4353      