 ...
 * @scope prototype
 */
class PluralizeViewHelper extends PluralizeViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Kickstart\ViewHelpers\Inflect\PluralizeViewHelper');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Kickstart\ViewHelpers\Inflect\PluralizeViewHelper', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Kickstart_ViewHelpers_Inflect_PluralizeViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper3900      