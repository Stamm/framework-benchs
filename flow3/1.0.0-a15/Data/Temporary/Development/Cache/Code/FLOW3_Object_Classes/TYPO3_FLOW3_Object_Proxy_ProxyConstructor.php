 ...
 */
class ProxyConstructor extends ProxyConstructor_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (!isset($arguments[0])) throw new \TYPO3\FLOW3\Object\Exception\UnresolvedDependenciesException('Missing required constructor argument $fullOriginalClassName in class ' . __CLASS__ . '. Note that constructor injection is only support for objects of scope singleton (and this is not a singleton) – for other scopes you must pass each required argument to the constructor yourself.', 1296143788);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Object\Proxy\ProxyConstructor');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Object\Proxy\ProxyConstructor', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Object_Proxy_ProxyConstructor %CLASS%TYPO3_FLOW3_Object_Proxy_ProxyMethod4359      