 ...
 * @scope prototype
 */
class JsonViewHelper extends JsonViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Fluid\ViewHelpers\Identity\JsonViewHelper');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\ViewHelpers\Identity\JsonViewHelper', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Fluid_ViewHelpers_Identity_JsonViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper3954      