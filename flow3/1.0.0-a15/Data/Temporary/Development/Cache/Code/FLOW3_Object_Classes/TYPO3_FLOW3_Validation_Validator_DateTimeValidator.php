 ...
 * @scope prototype
 */
class DateTimeValidator extends DateTimeValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\DateTimeValidator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\DateTimeValidator', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->injectDatetimeParser(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\Parser\DatetimeParser'));
	}
}
#0             %CLASS%TYPO3_FLOW3_Validation_Validator_DateTimeValidator %CLASS%TYPO3_FLOW3_Validation_Validator_AbstractValidator4162      