...
class Error extends Error_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Error\Error');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Error\Error', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Error_Error %CLASS%TYPO3_FLOW3_Error_Message4431      