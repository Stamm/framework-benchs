 ...
 * @scope prototype
 */
class PasswordViewHelper extends PasswordViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Fluid\ViewHelpers\Form\PasswordViewHelper');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\ViewHelpers\Form\PasswordViewHelper', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Fluid_ViewHelpers_Form_PasswordViewHelper %CLASS%TYPO3_Fluid_ViewHelpers_Form_AbstractFormFieldViewHelper %CLASS%TYPO3_Fluid_ViewHelpers_Form_AbstractFormViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper4063      