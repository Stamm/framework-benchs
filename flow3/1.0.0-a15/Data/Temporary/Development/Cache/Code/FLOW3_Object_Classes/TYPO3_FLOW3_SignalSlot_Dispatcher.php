...
class Dispatcher extends Dispatcher_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\SignalSlot\Dispatcher', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\SignalSlot\Dispatcher');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\SignalSlot\Dispatcher', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_SignalSlot_Dispatcher3979      