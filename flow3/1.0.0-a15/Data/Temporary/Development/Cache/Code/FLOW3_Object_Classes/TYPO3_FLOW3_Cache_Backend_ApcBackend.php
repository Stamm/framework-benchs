 ...
 * @scope prototype
 */
class ApcBackend extends ApcBackend_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Cache\Backend\ApcBackend');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Cache\Backend\ApcBackend', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Cache_Backend_ApcBackend %CLASS%TYPO3_FLOW3_Cache_Backend_AbstractBackend4409      