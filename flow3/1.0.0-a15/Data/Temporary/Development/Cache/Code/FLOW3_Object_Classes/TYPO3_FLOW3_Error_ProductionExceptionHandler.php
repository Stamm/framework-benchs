 ...
 * @scope singleton
 */
class ProductionExceptionHandler extends ProductionExceptionHandler_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Error\ProductionExceptionHandler', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Error\ProductionExceptionHandler');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Error\ProductionExceptionHandler', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Error_ProductionExceptionHandler %CLASS%TYPO3_FLOW3_Error_AbstractExceptionHandler4070      