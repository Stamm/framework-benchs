 ...
 * @scope singleton
 */
class Functions extends Functions_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Utility\Unicode\Functions', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Utility\Unicode\Functions');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Utility\Unicode\Functions', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Utility_Unicode_Functions3688      