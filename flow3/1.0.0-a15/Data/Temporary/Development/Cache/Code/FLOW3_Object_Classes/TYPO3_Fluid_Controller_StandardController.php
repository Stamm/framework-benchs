 ...
 */
class StandardController extends StandardController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Fluid\Controller\StandardController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\Controller\StandardController', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectXsdGenerator(new \TYPO3\Fluid\Service\XsdGenerator());
		$this->injectView(new \TYPO3\Fluid\View\TemplateView());
...
#0             %CLASS%TYPO3_Fluid_Controller_StandardController %CLASS%TYPO3_FLOW3_MVC_Controller_ActionController %CLASS%TYPO3_FLOW3_MVC_Controller_AbstractController4841      