 ...
 * @scope singleton
 */
class ObjectConverter extends ObjectConverter_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Property\TypeConverter\ObjectConverter', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Property\TypeConverter\ObjectConverter');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Property\TypeConverter\ObjectConverter', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Property_TypeConverter_ObjectConverter %CLASS%TYPO3_FLOW3_Property_TypeConverter_AbstractTypeConverter4349      