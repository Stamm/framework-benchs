 ...
 * @scope prototype
 */
class BeforeAdvice extends BeforeAdvice_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\AOP\Advice\BeforeAdvice');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\AOP\Advice\BeforeAdvice', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_AOP_Advice_BeforeAdvice %CLASS%TYPO3_FLOW3_AOP_Advice_AbstractAdvice4701      