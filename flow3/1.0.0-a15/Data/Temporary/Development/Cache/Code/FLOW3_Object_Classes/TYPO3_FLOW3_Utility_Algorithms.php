 ...
 * @scope singleton
 */
class Algorithms extends Algorithms_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Utility\Algorithms', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Utility\Algorithms');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Utility\Algorithms', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Utility_Algorithms3654      