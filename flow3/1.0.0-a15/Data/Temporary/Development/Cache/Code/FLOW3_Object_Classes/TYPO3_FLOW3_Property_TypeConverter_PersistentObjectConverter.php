 ...
 * @scope singleton
 */
class PersistentObjectConverter extends PersistentObjectConverter_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Property\TypeConverter\PersistentObjectConverter', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Property\TypeConverter\PersistentObjectConverter');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Property\TypeConverter\PersistentObjectConverter', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Property_TypeConverter_PersistentObjectConverter %CLASS%TYPO3_FLOW3_Property_TypeConverter_AbstractTypeConverter4409      