 ...
 * @scope singleton
 */
class AccessDeny extends AccessDeny_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\Interceptor\AccessDeny', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Authorization\Interceptor\AccessDeny');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Authorization\Interceptor\AccessDeny', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Authorization_Interceptor_AccessDeny3789      