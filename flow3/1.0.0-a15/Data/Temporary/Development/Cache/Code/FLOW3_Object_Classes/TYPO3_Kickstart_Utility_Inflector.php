 ...
 */
class Inflector extends Inflector_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Kickstart\Utility\Inflector');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Kickstart\Utility\Inflector', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Kickstart_Utility_Inflector3350      