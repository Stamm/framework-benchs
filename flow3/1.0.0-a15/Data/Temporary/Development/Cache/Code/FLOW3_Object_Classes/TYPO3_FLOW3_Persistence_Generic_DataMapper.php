 ...
 * @scope singleton
 */
class DataMapper extends DataMapper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Persistence\Generic\DataMapper', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Persistence\Generic\DataMapper');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Persistence\Generic\DataMapper', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Persistence_Generic_DataMapper4161      