 ...
 * @scope singleton
 */
class XliffTranslationProvider extends XliffTranslationProvider_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\I18n\TranslationProvider\XliffTranslationProvider', $this);
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\I18n\TranslationProvider\TranslationProviderInterface', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\I18n\TranslationProvider\XliffTranslationProvider');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\I18n\TranslationProvider\XliffTranslationProvider', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectLocalizationService(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\Service'));
		$this->injectPluralsReader(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\Cldr\Reader\PluralsReader'));
	}
}
#0             %CLASS%TYPO3_FLOW3_I18n_TranslationProvider_XliffTranslationProvider4538      