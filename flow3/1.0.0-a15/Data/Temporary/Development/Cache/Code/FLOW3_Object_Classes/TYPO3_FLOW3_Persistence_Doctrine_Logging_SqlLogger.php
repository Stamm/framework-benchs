 ...
 * @scope prototype
 */
class SqlLogger extends SqlLogger_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Persistence\Doctrine\Logging\SqlLogger');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Persistence\Doctrine\Logging\SqlLogger', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->logger = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Log\LoggerFactory')->create('Sql_Queries', 'TYPO3\\FLOW3\\Log\\Logger', 'TYPO3\\FLOW3\\Log\\Backend\\FileBackend', \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->getSettingsByPath(explode('.', 'TYPO3.FLOW3.log.sqlLogger.backendOptions')));
	}
}
#0             %CLASS%TYPO3_FLOW3_Persistence_Doctrine_Logging_SqlLogger4008      