 ...
 * @scope singleton
 */
class AuthenticationProviderResolver extends AuthenticationProviderResolver_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authentication\AuthenticationProviderResolver', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Authentication\AuthenticationProviderResolver');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Authentication\AuthenticationProviderResolver', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Authentication_AuthenticationProviderResolver4466      