 ...
 */
class PersonRepository extends PersonRepository_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Party\Domain\Repository\PersonRepository');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Party\Domain\Repository\PersonRepository', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Party_Domain_Repository_PersonRepository %CLASS%TYPO3_FLOW3_Persistence_Repository3824      