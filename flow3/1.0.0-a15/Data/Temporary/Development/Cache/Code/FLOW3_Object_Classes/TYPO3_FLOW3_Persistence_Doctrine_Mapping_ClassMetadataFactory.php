 ...
 */
class ClassMetadataFactory extends ClassMetadataFactory_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Persistence\Doctrine\Mapping\ClassMetadataFactory');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Persistence\Doctrine\Mapping\ClassMetadataFactory', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Persistence_Doctrine_Mapping_ClassMetadataFactory %CLASS%Doctrine_ORM_Mapping_ClassMetadataFactory3445      