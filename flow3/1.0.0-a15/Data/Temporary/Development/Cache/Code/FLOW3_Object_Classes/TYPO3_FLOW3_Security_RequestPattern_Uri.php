...
class Uri extends Uri_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\RequestPattern\Uri');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\RequestPattern\Uri', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_RequestPattern_Uri3382      