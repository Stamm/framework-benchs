 ...
 * @scope prototype
 */
class NumberRangeValidator extends NumberRangeValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\NumberRangeValidator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\NumberRangeValidator', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Validation_Validator_NumberRangeValidator %CLASS%TYPO3_FLOW3_Validation_Validator_AbstractValidator3746      