 ...
 * @scope singleton
 */
class YamlParser extends YamlParser_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Configuration\Source\YamlParser', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Configuration\Source\YamlParser');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Configuration\Source\YamlParser', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Configuration_Source_YamlParser %CLASS%Horde_Yaml3719      