 ...
 * @scope prototype
 */
class Configuration extends Configuration_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\Core\Parser\Configuration', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Fluid_Core_Parser_Configuration3386      