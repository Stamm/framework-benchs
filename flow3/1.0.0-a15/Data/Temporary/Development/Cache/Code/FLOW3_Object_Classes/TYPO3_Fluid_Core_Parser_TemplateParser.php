 ...
 */
class TemplateParser extends TemplateParser_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Fluid\Core\Parser\TemplateParser');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\Core\Parser\TemplateParser', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Fluid_Core_Parser_TemplateParser3783      