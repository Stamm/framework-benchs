 ...
 * @scope singleton
 */
class ModificationTimeStrategy extends ModificationTimeStrategy_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Monitor\ChangeDetectionStrategy\ModificationTimeStrategy', $this);
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Monitor\ChangeDetectionStrategy\ChangeDetectionStrategyInterface', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Monitor\ChangeDetectionStrategy\ModificationTimeStrategy');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Monitor\ChangeDetectionStrategy\ModificationTimeStrategy', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Monitor_ChangeDetectionStrategy_ModificationTimeStrategy4786      