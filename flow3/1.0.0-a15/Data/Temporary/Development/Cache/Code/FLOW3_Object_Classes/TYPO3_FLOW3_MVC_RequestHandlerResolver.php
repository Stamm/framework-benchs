 ...
 * @scope singleton
 */
class RequestHandlerResolver extends RequestHandlerResolver_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\MVC\RequestHandlerResolver', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\RequestHandlerResolver');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\RequestHandlerResolver', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_MVC_RequestHandlerResolver4150      