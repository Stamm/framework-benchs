 ...
 * @scope prototype
 */
class QueryObjectModelFactory extends QueryObjectModelFactory_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Persistence\Generic\Qom\QueryObjectModelFactory');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Persistence\Generic\Qom\QueryObjectModelFactory', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Persistence_Generic_Qom_QueryObjectModelFactory3850      