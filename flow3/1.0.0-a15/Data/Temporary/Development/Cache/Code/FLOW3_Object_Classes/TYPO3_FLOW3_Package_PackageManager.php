 ...
 * @scope singleton
 */
class PackageManager extends PackageManager_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Package\PackageManager', $this);
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Package\PackageManagerInterface', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Package\PackageManager');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Package\PackageManager', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectClassLoader(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Core\ClassLoader'));
	}
}
#0             %CLASS%TYPO3_FLOW3_Package_PackageManager4213      