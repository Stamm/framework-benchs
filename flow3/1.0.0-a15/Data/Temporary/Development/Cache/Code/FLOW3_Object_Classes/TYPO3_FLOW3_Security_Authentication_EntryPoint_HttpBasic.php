 ...
 * @scope prototype
 */
class HttpBasic extends HttpBasic_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Authentication\EntryPoint\HttpBasic');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Authentication\EntryPoint\HttpBasic', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Authentication_EntryPoint_HttpBasic3439      