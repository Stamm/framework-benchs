 ...
 * @scope prototype
 */
class ObjectAccessorNode extends ObjectAccessorNode_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (!isset($arguments[0])) throw new \TYPO3\FLOW3\Object\Exception\UnresolvedDependenciesException('Missing required constructor argument $objectPath in class ' . __CLASS__ . '. Note that constructor injection is only support for objects of scope singleton (and this is not a singleton) – for other scopes you must pass each required argument to the constructor yourself.', 1296143788);
...
#0             %CLASS%TYPO3_Fluid_Core_Parser_SyntaxTree_ObjectAccessorNode %CLASS%TYPO3_Fluid_Core_Parser_SyntaxTree_AbstractNode4074      