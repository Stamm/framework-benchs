 ...
 * @scope prototype
 */
class MvcPropertyMappingConfiguration extends MvcPropertyMappingConfiguration_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\Controller\MvcPropertyMappingConfiguration');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\Controller\MvcPropertyMappingConfiguration', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_MVC_Controller_MvcPropertyMappingConfiguration %CLASS%TYPO3_FLOW3_Property_PropertyMappingConfiguration3467      