 ...
 * @scope prototype
 */
class PropertyMappingConfiguration extends PropertyMappingConfiguration_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Property\PropertyMappingConfiguration');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Property\PropertyMappingConfiguration', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Property_PropertyMappingConfiguration3437      