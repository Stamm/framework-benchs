 ...
 * @scope prototype
 */
class ControllerObjectName extends ControllerObjectName_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\RequestPattern\ControllerObjectName');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\RequestPattern\ControllerObjectName', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_RequestPattern_ControllerObjectName3450      