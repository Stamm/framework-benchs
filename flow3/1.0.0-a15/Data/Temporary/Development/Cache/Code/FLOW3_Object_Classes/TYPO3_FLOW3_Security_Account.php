	 ...
	 public function __clone() {
		...
		$result = NULL;
			...
			try {
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Security\Account', '__clone', $methodArguments, NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
...
#0             %CLASS%TYPO3_FLOW3_Security_Account %CLASS%_TYPO3_FLOW3_Persistence_Aspect_PersistenceMagicInterface8190      