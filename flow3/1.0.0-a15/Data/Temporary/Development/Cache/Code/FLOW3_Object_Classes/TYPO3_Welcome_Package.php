...
class Package extends Package_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Welcome\Package');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Welcome\Package', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Welcome_Package %CLASS%TYPO3_FLOW3_Package_Package4391      