 ...
 * @scope singleton
 */
class LabelValidator extends LabelValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Validation\Validator\LabelValidator', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\LabelValidator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\LabelValidator', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Validation_Validator_LabelValidator %CLASS%TYPO3_FLOW3_Validation_Validator_AbstractValidator3970      