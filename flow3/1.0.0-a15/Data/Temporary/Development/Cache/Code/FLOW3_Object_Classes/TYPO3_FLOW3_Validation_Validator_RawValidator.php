 ...
 * @scope singleton
 */
class RawValidator extends RawValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Validation\Validator\RawValidator', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\RawValidator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\RawValidator', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Validation_Validator_RawValidator3731      