 ...
 * @scope prototype
 */
class RegularExpressionValidator extends RegularExpressionValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\RegularExpressionValidator');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\RegularExpressionValidator', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Validation_Validator_RegularExpressionValidator %CLASS%TYPO3_FLOW3_Validation_Validator_AbstractValidator3770      