 ...
 * @scope singleton
 */
class SecurityCommandController extends SecurityCommandController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Command\SecurityCommandController', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Command\SecurityCommandController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Command\SecurityCommandController', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->rsaWalletService = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Security\Cryptography\RsaWalletServicePhp');
	}
}
#0             %CLASS%TYPO3_FLOW3_Command_SecurityCommandController %CLASS%TYPO3_FLOW3_MVC_Controller_CommandController4223      