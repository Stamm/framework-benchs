 ...
 * @scope singleton
 */
class RsaWalletServicePhp extends RsaWalletServicePhp_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Cryptography\RsaWalletServicePhp', $this);
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Cryptography\RsaWalletServiceInterface', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Cryptography\RsaWalletServicePhp');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Cryptography\RsaWalletServicePhp', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Cryptography_RsaWalletServicePhp4775      