 ...
 * @scope prototype
 */
class Logger extends Logger_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Log\Logger');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Log\Logger', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Log_Logger3679      