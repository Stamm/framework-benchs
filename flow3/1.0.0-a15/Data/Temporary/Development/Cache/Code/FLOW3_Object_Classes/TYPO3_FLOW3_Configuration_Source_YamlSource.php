 ...
 * @scope singleton
 */
class YamlSource extends YamlSource_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Configuration\Source\YamlSource', $this);
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Configuration\Source\SourceInterface', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Configuration\Source\YamlSource');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Configuration\Source\YamlSource', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Configuration_Source_YamlSource3969      