 ...
 * @scope prototype
 */
class NumberViewHelper extends NumberViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\ViewHelpers\Format\NumberViewHelper', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Fluid_ViewHelpers_Format_NumberViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper3810      