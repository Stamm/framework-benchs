 ...
 * @scope singleton
 */
class NotFoundController extends NotFoundController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\MVC\Controller\NotFoundController', $this);
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\MVC\Controller\NotFoundControllerInterface', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\Controller\NotFoundController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\Controller\NotFoundController', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectNotFoundView(new \TYPO3\FLOW3\MVC\View\NotFoundView());
...
#0             %CLASS%TYPO3_FLOW3_MVC_Controller_NotFoundController %CLASS%TYPO3_FLOW3_MVC_Controller_AbstractController5068      