...
class TranslateViewHelper extends TranslateViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectTranslator(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\I18n\Translator'));
		$this->injectReflectionService(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Reflection\ReflectionService'));
	}
}
#0             %CLASS%TYPO3_Fluid_ViewHelpers_TranslateViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper3915      