 ...
 * @scope singleton
 */
class ValidatorResolver extends ValidatorResolver_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Validation\ValidatorResolver', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\ValidatorResolver');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\ValidatorResolver', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Validation_ValidatorResolver4639      