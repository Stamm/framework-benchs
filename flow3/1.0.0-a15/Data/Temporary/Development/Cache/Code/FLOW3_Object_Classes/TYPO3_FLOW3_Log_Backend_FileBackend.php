...
class FileBackend extends FileBackend_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Log\Backend\FileBackend');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Log\Backend\FileBackend', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Log_Backend_FileBackend %CLASS%TYPO3_FLOW3_Log_Backend_AbstractBackend3378      