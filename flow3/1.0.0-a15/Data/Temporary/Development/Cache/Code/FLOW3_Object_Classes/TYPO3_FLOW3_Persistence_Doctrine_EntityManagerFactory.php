 ...
 * @scope singleton
 */
class EntityManagerFactory extends EntityManagerFactory_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Persistence\Doctrine\EntityManagerFactory', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Persistence\Doctrine\EntityManagerFactory');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Persistence\Doctrine\EntityManagerFactory', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Persistence_Doctrine_EntityManagerFactory4584      