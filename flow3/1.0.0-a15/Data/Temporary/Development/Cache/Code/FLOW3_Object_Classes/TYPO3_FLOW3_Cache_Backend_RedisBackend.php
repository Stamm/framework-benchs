 ...
 * @scope prototype
 */
class RedisBackend extends RedisBackend_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Cache\Backend\RedisBackend');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Cache\Backend\RedisBackend', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Cache_Backend_RedisBackend %CLASS%TYPO3_FLOW3_Cache_Backend_AbstractBackend4501      