 ...
 * @scope singleton
 */
class TemplateCompiler extends TemplateCompiler_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\Fluid\Core\Compiler\TemplateCompiler', $this);
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectTemplateCache(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Cache\CacheManager')->getCache('Fluid_TemplateCache'));
	}
}
#0             %CLASS%TYPO3_Fluid_Core_Compiler_TemplateCompiler4052      