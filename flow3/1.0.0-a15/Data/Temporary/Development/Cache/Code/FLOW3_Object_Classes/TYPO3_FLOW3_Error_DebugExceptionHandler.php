 ...
 * @scope singleton
 */
class DebugExceptionHandler extends DebugExceptionHandler_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Error\DebugExceptionHandler', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Error\DebugExceptionHandler');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Error\DebugExceptionHandler', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Error_DebugExceptionHandler %CLASS%TYPO3_FLOW3_Error_AbstractExceptionHandler4040      