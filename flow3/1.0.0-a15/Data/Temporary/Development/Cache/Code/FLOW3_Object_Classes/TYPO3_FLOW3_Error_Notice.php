 ...
 * @scope prototype
 */
class Notice extends Notice_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Error\Notice');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Error\Notice', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Error_Notice %CLASS%TYPO3_FLOW3_Error_Message4435      