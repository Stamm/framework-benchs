 ...
 * @scope prototype
 */
class ValidationResultsViewHelper extends ValidationResultsViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Fluid\ViewHelpers\Form\ValidationResultsViewHelper');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\ViewHelpers\Form\ValidationResultsViewHelper', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Fluid_ViewHelpers_Form_ValidationResultsViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper3848      