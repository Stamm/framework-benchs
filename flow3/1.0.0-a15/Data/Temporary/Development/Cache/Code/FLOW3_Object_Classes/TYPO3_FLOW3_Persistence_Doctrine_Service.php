...
class Service extends Service_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Persistence\Doctrine\Service', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Persistence\Doctrine\Service');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Persistence\Doctrine\Service', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->entityManager = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('Doctrine\Common\Persistence\ObjectManager');
		$this->packageManager = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Package\PackageManagerInterface');
	}
}
#0             %CLASS%TYPO3_FLOW3_Persistence_Doctrine_Service4377      