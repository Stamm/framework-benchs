 ...
 * @scope prototype
 */
class UsernamePasswordHttpBasic extends UsernamePasswordHttpBasic_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Authentication\Token\UsernamePasswordHttpBasic');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Authentication\Token\UsernamePasswordHttpBasic', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_Authentication_Token_UsernamePasswordHttpBasic %CLASS%TYPO3_FLOW3_Security_Authentication_Token_UsernamePassword3986      