 ...
 * @scope prototype
 */
class Person extends Person_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Package\MetaData\Person');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Package\MetaData\Person', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Package_MetaData_Person %CLASS%TYPO3_FLOW3_Package_MetaData_AbstractParty4477      