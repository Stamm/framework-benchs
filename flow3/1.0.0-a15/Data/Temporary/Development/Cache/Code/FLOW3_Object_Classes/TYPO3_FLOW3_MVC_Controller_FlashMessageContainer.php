 ...
 * @scope session
 */
class FlashMessageContainer extends FlashMessageContainer_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\MVC\Controller\FlashMessageContainer', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\Controller\FlashMessageContainer');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\Controller\FlashMessageContainer', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_MVC_Controller_FlashMessageContainer3753      