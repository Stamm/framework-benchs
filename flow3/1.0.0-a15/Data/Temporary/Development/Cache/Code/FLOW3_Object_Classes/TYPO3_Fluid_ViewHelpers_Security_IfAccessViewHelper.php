 ...
 * @scope prototype
 */
class IfAccessViewHelper extends IfAccessViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\ViewHelpers\Security\IfAccessViewHelper', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectAccessDecisionManager(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Security\Authorization\AccessDecisionManagerInterface'));
		$this->injectReflectionService(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Reflection\ReflectionService'));
	}
}
#0             %CLASS%TYPO3_Fluid_ViewHelpers_Security_IfAccessViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractConditionViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper4012      