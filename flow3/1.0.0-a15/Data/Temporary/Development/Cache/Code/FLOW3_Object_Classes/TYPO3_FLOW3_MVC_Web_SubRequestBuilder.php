 ...
 * @scope singleton
 */
class SubRequestBuilder extends SubRequestBuilder_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\MVC\Web\SubRequestBuilder', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\Web\SubRequestBuilder');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\Web\SubRequestBuilder', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_MVC_Web_SubRequestBuilder4125      