 ...
 * @scope singleton
 */
class ConfigurationManager extends ConfigurationManager_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Configuration\ConfigurationManager', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Configuration\ConfigurationManager');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Configuration\ConfigurationManager', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectConfigurationSource(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Configuration\Source\YamlSource'));
		$this->injectEnvironment(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Utility\Environment'));
	}
}
#0             %CLASS%TYPO3_FLOW3_Configuration_ConfigurationManager4613      