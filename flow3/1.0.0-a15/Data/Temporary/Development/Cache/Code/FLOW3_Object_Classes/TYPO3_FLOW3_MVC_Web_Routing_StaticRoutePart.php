 ...
 * @scope prototype
 */
class StaticRoutePart extends StaticRoutePart_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\Web\Routing\StaticRoutePart');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\Web\Routing\StaticRoutePart', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_MVC_Web_Routing_StaticRoutePart %CLASS%TYPO3_FLOW3_MVC_Web_Routing_AbstractRoutePart3406      