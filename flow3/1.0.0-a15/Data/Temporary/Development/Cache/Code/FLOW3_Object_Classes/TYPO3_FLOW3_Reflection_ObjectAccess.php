 ...
 */
class ObjectAccess extends ObjectAccess_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Reflection\ObjectAccess');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Reflection\ObjectAccess', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Reflection_ObjectAccess3359      