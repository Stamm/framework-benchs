 ...
 * @scope prototype
 */
class IpAddressRange extends IpAddressRange_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\RequestPattern\IpAddressRange');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\RequestPattern\IpAddressRange', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Security_RequestPattern_IpAddressRange3426      