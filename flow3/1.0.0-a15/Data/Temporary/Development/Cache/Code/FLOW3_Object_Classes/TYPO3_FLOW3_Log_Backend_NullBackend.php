...
class NullBackend extends NullBackend_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Log\Backend\NullBackend');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Log\Backend\NullBackend', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Log_Backend_NullBackend %CLASS%TYPO3_FLOW3_Log_Backend_AbstractBackend3378      